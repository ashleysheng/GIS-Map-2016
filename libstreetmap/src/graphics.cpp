...
build_default_menu(void) {
    ...
    const int NUM_ARROW_BUTTONS = 4, NUM_STANDARD_BUTTONS = 11, SEPARATOR_BUTTON_INDEX = 8;
...
//    menu_attributes.event_mask = 0;
    ...
    strcpy(button_state.button[9].text, "City Select");
    strcpy(button_state.button[10].text, "Exit");
    ...
    button_state.button[9].fcn = proceed;
    button_state.button[10].fcn = quit;
